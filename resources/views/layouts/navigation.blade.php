<nav class="bg-white border-b border-gray-200 pb-4 lg:pb-0">
            ...
            <div class="flex justify-center space-x-4 w-full sm:w-auto sm:mb-4 lg:mb-0">
                ...
                @auth
                    ...
                    <a href="{{ route('dashboard') }}"
                        class="bg-blue-500 hover:bg-blue-600 text-white font-semibold px-4 py-1 rounded shadow whitespace-nowrap text-center">
                        ダッシュボードへ
                    </a>
