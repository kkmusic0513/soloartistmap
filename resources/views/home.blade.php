<x-app-layout>
    ...
    {{-- 最新動画 セクション（フルワイド背景） --}}
    <section class="relative left-1/2 right-1/2 -ml-[50vw] -mr-[50vw] w-[100vw] bg-[#252525] py-12 mb-12">
        {{-- コンテンツ部分は中央揃えの最大幅を維持 --}}
    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-10">
        ...
        <section class="relative left-1/2 right-1/2 -ml-[50vw] -mr-[50vw] w-[100vw] bg-[#252525] px-4 py-12">
